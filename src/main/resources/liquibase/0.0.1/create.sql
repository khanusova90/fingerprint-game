...
INSERT INTO `fingerprint_game`.`c_activity` (`ID_ACTIVITY`, `NAME`) VALUES ('1', 'Tìžit');
INSERT INTO `fingerprint_game`.`c_activity` (`ID_ACTIVITY`, `NAME`) VALUES ('2', 'Smìnit suroviny');
